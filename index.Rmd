...
### Datos para descarga: [Capa geoespacial de infraestructura verde del cantón de San José](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/sanjose/IV_SAN_JOSE.TIF)
```{r}
